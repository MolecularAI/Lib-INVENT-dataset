REACTION_SMIRKS_ALL = ["[#6;$(C[C;$(C([#6]))]):4]-!@[N;$([NH1;D2](C)C);!$(N-[#6]=[*]);$(N([C])):3]>>[#6:4][*].[N:3][*]",
...
COMPOUND = "Brc1cccc(Nc2ncnc3ccncc23)c1NCCN1CCOCC1"

WORKING_REACTION = '[N;$(N-[#6]):3]-!@[C;$(C=O):1]-!@[N+0;$(N[#6]);!$(N=*);!$([N-]);!$(N#*);!$([ND1]);!$(N[O,N]):2]>>[*:1][*].[*:2][*]'

FAILED_REACTION_ROW = '[O:2]=[#6:1][#7:5]>>[O:2]=[#6:1][*].[N:5][*]	CC(C)C(c1nnnn1CC1CCCO1)N(CCCO)Cc1cc2cc3c(cc2[nH]c1=O)OCCO3'

FAILED_REACTION = '[#6;!$([#6]=*);!$([#6]~[O,N,S]);$([#6]~[#6]):1][#6;!$([#6]=*);!$([#6]~[O,N,S]);$([#6]~[#6]):2]>>[#6;!$([#6]=*);!$([#6]~[O,N,S]);$([#6]~[#6]):1][*].[#6;!$([#6]=*);!$([#6]~[O,N,S]);$([#6]~[#6]):2][*]'

SCAFFOLD = "[*]C#CC=CCN(Cc1cccc2c(Br)csc12)[*]"

DECORATIONS = "*C(C)(C)C|*C"

ORIGINAL = "CN(CC=CC#CC(C)(C)C)Cc1cccc2c(Br)csc12"

RELABELING_DICT =  {0: '*CC', 1: '*O', 2: '*C'}

ROW = '[*]C#CC=CCN(Cc1cccc2c(Br)csc12)[*]	*C(C)(C)C|*C	CN(CC=CC#CC(C)(C)C)Cc1cccc2c(Br)csc12'