...
in two main folders:
- [data_preparation](../blob/main/data_preparation) contains scripts necessary for the preparation of the data before the model is trained. The functionality
includes reaction based slicing, dataset profiling and filtering based on user defined criteria.

- [results_analysis](../blob/main/resultes_analysis) works with the output of the Lib-INVENT model, scaffold memory csv files, as well as tensorboard logs
...
Tutorials
------------------------------------------------------------------------------------------------------------------------
Two [tutorials](../blob/main/tutorial) walking through the process of data preparation for Lib-INVENT experiments is provided in the folder
